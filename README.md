...
Three views, one story: **Driver Dashboard** (customer), **Live Rating Engine** (the live-recompute proof), **Underwriter Console** (business). A **light/dark theme** toggle (default light) and a **persona switcher** (Sarah / Marcus / Priya — each with a *distinct* dominant risk factor: mileage / hard braking / average speed) sit in the UI for the walkthrough.
